...
const Transfer = () => {
  ...
  // Determine initial transaction type from URL
  ...
  const handleSubmit = async (e) => {
    ...
    // Check for sufficient funds on withdrawal/transfer
    ...
    try {
      ...
      if (transactionType === 'deposit') {
        ...
        // If using account number, try to find the account
      ...
      setError(err.response?.data?.message || err.response?.data?.error || 'Transaction failed. Please try again.');
    } finally {
      setSubmitting(false);
    }
  };
            ...
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-xl font-bold text-gray-900">
                            {formatCurrency(selectedAccount.availableBalance || selectedAccount.balance)}
                          </p>
                        </div>
                      </div>
                      <div className="text-right">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          >
                            {copiedAccountNumber === selectedAccount.accountNumber ? (
                  ...
                  <div>
                    ...
                    <div className="relative my-4">
                      ...
                      <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-white text-gray-500">Or enter account number</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-500">
                        Enter the recipient's account number (format: XX##-####-####)
                      </p>
                    </div>
                  </div>
                )}
                ...
                <button
                  ...
                  } ${(submitting || accounts.length === 0) ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
                  {submitting ? (
